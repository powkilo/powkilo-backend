...
.constant('CONFIG', {
  ...
  // localStorage_token_key: "powkilo-api-key-localhost",

  api_login_uri: "https://powkilo.herokuapp.com/api/login.json",
  api_products_uri: "https://powkilo.herokuapp.com/api/products",

  // set to server address (ie http://www.servername.com) if image paths are local, else leave blank
  image_root: "",
  localStorage_token_key: "powkilo-api-key-heroku",
